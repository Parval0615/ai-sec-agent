...
Saves raw results and a comparison summary to R_raw/.
"""
import sys
import os
import json
...
from T_tools.test_cases import TEST_CASES

PDF_PATH = "docs/large_test.pdf"
REPORTS_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "R_raw")
